...
6. Get the *prediction URL* and *prediction key* from the dialog box you left open in the browser tab for your Custom Vision project(Task 5). You need the versions to be used *if you have an image URL*.
